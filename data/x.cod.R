...
"B", "Sel", "Dev", "Survey", "CAc", "CAs"), call = quote(importCol(res.file = "~/r/library/scape/example/cod.res", 
    Dev = TRUE, Survey = TRUE, CAc = TRUE, CAs = TRUE)), scape.version = "2.2.0", class = "scape")
